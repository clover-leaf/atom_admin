...
import 'package:atom_admin/common/t_simply_password_field.dart';
import 'package:atom_admin/common/t_simply_text_field.dart';
import 'package:atom_admin/common/t_snackbar.dart';
import 'package:atom_admin/gen/colors.gen.dart';
import 'package:atom_admin/home/view/home_page.dart';
import 'package:atom_admin/login/login.dart';
import 'package:atom_admin/signup/view/signup_page.dart';
        ...
        if (state.status.isWaiting()) {
          ...
          if (state.status.isSuccess()) {
            Navigator.of(context).pushAndRemoveUntil(
                HomePage.route(userId: state.userId), (route) => false);
